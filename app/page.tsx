  ...
  return (
    <main className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-24 relative z-10 w-full overflow-hidden">
      ...
      {/* =========================================
          Hero Section
          ========================================= */}
      <section id="home" className="relative mt-8">
        <div className="absolute -top-10 -right-10 w-64 h-64 border-t-2 border-r-2 border-primary rounded-tr-3xl opacity-20 pointer-events-none hidden lg:block"></div>
        <div className="absolute -top-6 -right-6 w-48 h-48 border-t border-r border-primary rounded-tr-xl opacity-40 pointer-events-none hidden lg:block"></div>

        <div className="glass-panel rounded-2xl p-8 md:p-12 lg:p-16 border border-gray-700/50 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-4 leading-tight">
              HELLO, I'M A <span className="text-primary neon-text-green">FRONTEND</span><br />
              <span className="text-white">DEVELOPER</span> &amp; <span className="text-white">GEOLOGIST</span>
            </h1>

            <div className="flex flex-wrap gap-3 mb-8">
              <span className="px-3 py-1 rounded-full border border-primary/50 text-primary text-xs font-display bg-primary/10">Frontend Developer</span>
              <span className="px-3 py-1 rounded-full border border-primary/50 text-primary text-xs font-display bg-primary/10">Geologist</span>
            </div>

            <p className="text-gray-400 text-lg mb-10 leading-relaxed max-w-2xl font-light">
      ...
      <section id="skills">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="glass-panel p-6 rounded-xl border border-secondary/30 hover:border-secondary/60 transition-colors shadow-[0_0_10px_rgba(59,130,246,0.1)] hover:shadow-[0_0_15px_rgba(59,130,246,0.2)] group">
            <h3 className="text-white font-display text-center mb-6 border-b border-gray-700 pb-2">PROGRAMMING LANGUAGES</h3>
            <div className="flex justify-center gap-4 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" aria-label="JavaScript" role="img" viewBox="0 0 512 512" className="w-12 h-12"><rect width="512" height="512" fill="#f7df1e"></rect><path d="m324,370c10,17 24,29 47,29 20,0 33,-10 33,-24 0,-16 -13,-22 -35,-32l-12,-5c-35,-15 -58,-33 -58,-72 0,-36 27,-64 70,-64 31,0 53,11 68,39l-37,24c-8,-15 -17,-21 -31,-21 -14,0 -23,9 -23,21 0,14 9,20 30,29l12,5c41,18 64,35 64,76 0,43 -34,67 -80,67 -45,0 -74,-21 -88,-49zm-170,4c8,13 14,25 31,25 16,0 26,-6 26,-30V203h48v164c0,50 -29,72 -72,72 -39,0 -61,-20 -72,-44z"></path></svg>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="w-12 h-12"><path fill="#007acc" d="M2,63.91v62.5H127V1.41H2Zm100.73-5a15.56,15.56,0,0,1,7.82,4.5,20.58,20.58,0,0,1,3,4c0,.16-5.4,3.81-8.69,5.85-.12.08-.6-.44-1.13-1.23a7.09,7.09,0,0,0-5.87-3.53c-3.79-.26-6.23,1.73-6.21,5a4.58,4.58,0,0,0,.54,2.34c.83,1.73,2.38,2.76,7.24,4.86,8.95,3.85,12.78,6.39,15.16,10,2.66,4,3.25,10.46,1.45,15.24-2,5.2-6.9,8.73-13.83,9.9a38.32,38.32,0,0,1-9.52-.1A23,23,0,0,1,80,109.19c-1.15-1.27-3.39-4.58-3.25-4.82a9.34,9.34,0,0,1,1.15-.73L82.5,101l3.59-2.08.75,1.11a16.78,16.78,0,0,0,4.74,4.54c4,2.1,9.46,1.81,12.16-.62a5.43,5.43,0,0,0,.69-6.92c-1-1.39-3-2.56-8.59-5-6.45-2.78-9.23-4.5-11.77-7.24a16.48,16.48,0,0,1-3.43-6.25,25,25,0,0,1-.22-8c1.33-6.23,6-10.58,12.82-11.87A31.66,31.66,0,0,1,102.73,58.93ZM73.39,64.15l0,5.12H57.16V115.5H45.65V69.26H29.38v-5a49.19,49.19,0,0,1,.14-5.16c.06-.08,10-.12,22-.1L73.33,59Z"></path></svg>
              <svg className="w-12 h-12" width="256px" height="255px" viewBox="0 0 256 255" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                  <defs>
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              {["JavaScript", "TypeScript", "Python", "SQL"].map(s => <span key={s} className="px-2 py-1 bg-gray-800 rounded-md text-xs border border-gray-600 text-gray-300">{s}</span>)}
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-xl border border-primary/30 hover:border-primary/60 transition-colors shadow-[0_0_10px_rgba(74,222,128,0.1)] hover:shadow-[0_0_15px_rgba(74,222,128,0.2)]">
            <h3 className="text-white font-display text-center mb-6 border-b border-gray-700 pb-2">MARKUP LANGUAGES</h3>
            <div className="flex flex-wrap justify-center gap-2 mt-4">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              {["HTML", "CSS", "Tailwind CSS", "Bootstrap"].map(s => <span key={s} className="px-2 py-1 bg-gray-800 rounded-md text-xs border border-gray-600 text-gray-300">{s}</span>)}
            </div>
          </div>

          {/* Tools */}
          <div className="glass-panel p-6 rounded-xl border border-secondary/30 hover:border-secondary/60 transition-colors shadow-[0_0_10px_rgba(59,130,246,0.1)] hover:shadow-[0_0_15px_rgba(59,130,246,0.2)]">
            <h3 className="text-white font-display text-center mb-6 border-b border-gray-700 pb-2">TOOLS</h3>
            <div className="flex justify-center gap-2 mb-4">
              <div className="text-[#F05032] w-12 h-12 flex items-center justify-center text-3xl"><i className="bi bi-git"></i></div>
              <div className="text-white w-12 h-12 flex items-center justify-center text-3xl"><i className="bi bi-github"></i></div>
              <svg className="w-12 h-12" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              {["Git", "GitHub", "VS Code", "Figma", "Postman", "MySql"].map(s => <span key={s} className="px-2 py-1 bg-gray-800 rounded-md text-xs border border-gray-600 text-gray-300">{s}</span>)}
            </div>
          </div>

          {/* Frameworks */}
          <div className="glass-panel p-6 rounded-xl border border-primary/30 hover:border-primary/60 transition-colors shadow-[0_0_10px_rgba(74,222,128,0.1)] hover:shadow-[0_0_15px_rgba(74,222,128,0.2)]">
            <h3 className="text-white font-display text-center mb-6 border-b border-gray-700 pb-2">FRAMEWORKS</h3>
            <div className="flex justify-center gap-4 mb-4 text-3xl">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.23174 23 20.46348" className="w-12 h-12" style={{color: "rgb(255, 255, 255)"}}>
      ...
      <section id="projects">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-display font-bold text-white uppercase tracking-wider">Projects</h2>
          <div className="h-1 w-24 bg-primary mx-auto mt-4 rounded-full shadow-[0_0_10px_rgba(74,222,128,0.6)]"></div>
        </div>
      ...
      {/* =========================================
          ...
          ========================================= */}
      <section>
        <div className="text-left mb-8 border-b border-gray-800 pb-4">
          <h2 className="text-2xl font-display font-bold text-white uppercase tracking-wider">MINI PROJECTS</h2>
        </div>
      ...
      <section id="about" className="pb-12">
        <div className="text-left mb-8 border-b border-gray-800 pb-4">
          <h2 className="text-2xl font-display font-bold text-white uppercase tracking-wider">ABOUT ME</h2>
        </div>

        <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
          <div className="relative w-64 h-64 shrink-0">
            <div className="absolute inset-0 rounded-full border-2 border-primary shadow-[0_0_20px_rgba(74,222,128,0.4)] animate-pulse"></div>
          ...
          <div className="glass-panel p-8 rounded-xl border border-primary/30 w-full max-w-2xl">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <i className="bi bi-person-fill text-primary text-xl mt-1"></i>
                <div>
                  <h3 className="text-lg text-primary font-bold">Narongrit Sornjai <span className="text-gray-400 text-sm font-normal">(alias)</span></h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-300">Department of Geology, Faculty of Science, Chulalongkorn University,</p>
                  <p className="text-gray-400 text-sm">2nd Class Honors</p>
                </div>
              </div>

              <div className="flex items-center gap-3">
                <i className="bi bi-envelope-fill text-primary text-xl"></i>
                <a href="mailto:sonjainarongrit15@gmail.com" className="text-gray-300 hover:text-white transition-colors">sonjainarongrit15@gmail.com</a>
              </div>

              <div className="flex items-center gap-3">
                <i className="bi bi-telephone-fill text-primary text-xl"></i>
                <a href="tel:0968187630" className="text-gray-300 hover:text-white transition-colors">(+66) 096-818-7630</a>
              </div>
            </div>

            <div className="mt-8 flex flex-wrap gap-4 items-center">
              <a href="/data/Resume_Narongrit_Sornjai.pdf" target="_blank" rel="noopener noreferrer" download="Resume_Narongrit_Sornjai.pdf" className="w-full sm:w-auto text-center px-8 py-3 bg-primary text-background-dark font-bold font-display rounded shadow-[0_0_15px_rgba(74,222,128,0.4)] hover:shadow-[0_0_25px_rgba(74,222,128,0.6)] hover:bg-green-400 transition-all transform hover:-translate-y-1">
                DOWNLOAD RESUME
              </a>

              <div className="flex gap-3 ml-auto mr-auto sm:mr-0">
                <a href="https://www.facebook.com/nar.ngrit.s.njai.cr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary hover:text-white transition-all"><i className="bi bi-facebook"></i></a>
                <a href="https://linkedin.com/in/narongrit-sornjai-53289b179" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary hover:text-white transition-all"><i className="bi bi-linkedin"></i></a>
              </div>
            </div>
          </div>
        </div>
